...
namespace DVLDMine
{
    public partial class frmEditApplicationFees: Form
    {
        private int _ApplicationTypeID = -1;
        private clsApplicationTypes _ApplicationType;

        public frmEditApplicationFees(int ApplicationType)
        {
            InitializeComponent();
        ...
        private void frmEditApplicationFees_Load(object sender, EventArgs e)
        {
        ...
        {
            //frmManageApplicationTypes manage = new frmManageApplicationTypes();
            //manage.ReloadGridView();
            this.Close();
        }
