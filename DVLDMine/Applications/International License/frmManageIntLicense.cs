...
namespace DVLDMine
{
    public partial class frmManageIntLicense: Form
    {
        private DataTable _dtInternationalLicenseApplications;

        public frmManageIntLicense()
        {
            InitializeComponent();
        }

        private void frmManageIntLicense_Load(object sender, EventArgs e)
        {
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            frm.ShowDialog();
            //refresh
            frmManageIntLicense_Load(null, null);
