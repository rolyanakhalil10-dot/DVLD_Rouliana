...
namespace DVLDMine
{
    public partial class frmAddUpdateLocalDLA: Form
    {
        ...
        public frmAddUpdateLocalDLA(int LocalDrivingLicenseApplicationID)
        {
            InitializeComponent();
            _Mode = enMode.Update;
        ...
        private void _LoadData()
        {
            ...
            ctrlPersonCardWithFilter221.LoadPersonInfo(_LocalDrivingLicenseApplication.ApplicantPersonID);
        ...
        private void DataBackEvent(object sender, int PersonID)
        {
            ...
            ctrlPersonCardWithFilter221.LoadPersonInfo(PersonID);
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            if (ctrlPersonCardWithFilter221.PersonID != -1)
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (clsLicense.IsLicenseExistByPersonID(ctrlPersonCardWithFilter221.PersonID, LicenseClassID))
            {
            ...
            _LocalDrivingLicenseApplication.ApplicantPersonID = ctrlPersonCardWithFilter221.PersonID; ;
        ...
        private void frmAddUpdateLocalDLA_Load(object sender, EventArgs e)
        {
            _ResetDefualtValues();
        ...
        private void frmAddUpdateLocalDLA_Activated(object sender, EventArgs e)
        {
            ctrlPersonCardWithFilter221.FilterFocus();
