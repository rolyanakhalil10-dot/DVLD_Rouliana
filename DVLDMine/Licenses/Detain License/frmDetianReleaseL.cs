...
namespace DVLDMine
{
    public partial class frmDetianReleaseL: Form
    {
        private int _DetainID = -1;
        private int _SelectedLicenseID = -1;

        public frmDetianReleaseL()
        {
            InitializeComponent();
        }

        private void frmDetianReleaseL_Load(object sender, EventArgs e)
        {
        ...
        private void frmDetianReleaseL_Activated(object sender, EventArgs e)
        {
