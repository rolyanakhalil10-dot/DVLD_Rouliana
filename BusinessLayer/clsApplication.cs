...
namespace BusinessLayer
{
    public class clsApplication
    {
        ...
        private bool _AddNewApplication()
        {
            ...
            this.ApplicationID = clsApplicationData1.AddNewApplication(
        ...
        private bool _UpdateApplication()
        {
            ...
            return clsApplicationData1.UpdateApplication(this.ApplicationID, this.ApplicantPersonID, this.ApplicationDate,
                this.ApplicationTypeID, (byte)this.ApplicationStatus,
                this.LastStatusDate, this.PaidFees, this.CreatedByUserID);
        ...
        public static clsApplication FindBaseApplication(int ApplicationID)
        {
            ...
            bool IsFound = clsApplicationData1.GetApplicationInfoByID
                                (
        ...
        {
            return clsApplicationData1.UpdateStatus(ApplicationID, 2);
        }

        public bool SetComplete()

        {
            return clsApplicationData1.UpdateStatus(ApplicationID, 3);
        }
        ...
        public bool Delete()
        {
            return clsApplicationData1.DeleteApplication(this.ApplicationID);
        }

        public static bool IsApplicationExist(int ApplicationID)
        {
            return clsApplicationData1.IsApplicationExist(ApplicationID);
        }

        public static bool DoesPersonHaveActiveApplication(int PersonID, int ApplicationTypeID)
        {
            return clsApplicationData1.DoesPersonHaveActiveApplication(PersonID, ApplicationTypeID);
        }
        ...
        {
            return clsApplicationData1.GetActiveApplicationID(PersonID, (int)ApplicationTypeID);
        }

        public static int GetActiveApplicationIDForLicenseClass(int PersonID, clsApplication.enApplicationType ApplicationTypeID, int LicenseClassID)
        {
            return clsApplicationData1.GetActiveApplicationIDForLicenseClass(PersonID, (int)ApplicationTypeID, LicenseClassID);
        }
